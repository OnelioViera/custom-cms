...
export default function NewProjectPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex">
            ...
            {/* Main Content Area */}
            <div className={`flex-1 ml-64 ${showPreview ? 'mr-[600px]' : ''} transition-all duration-300`}>
                {/* Header */}
                <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
                    <div className="px-6 py-4 flex items-center justify-between">
                        <div>
                            <h1 className="text-lg font-bold text-gray-900">Create New Project</h1>
            ...
            {showPreview && (
                <aside className="w-[600px] bg-gray-50 border-l border-gray-200 fixed right-0 top-0 h-full z-20 flex flex-col">
