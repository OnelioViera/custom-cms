...
import { Webhook, WebhookLog } from "./cms-models"
import type { ContentTypeField } from "@/types/cms"

// ============================================================================
// ERROR HANDLING
// ============================================================================

export function sendError(message: string, statusCode = 400) {
  return NextResponse.json({ success: false, error: message }, { status: statusCode })
}

export function sendSuccess(data: any, message?: string, statusCode = 200) {
...
export function generateToken(userId: string, siteId: string): string {
  return jwt.sign({ userId, siteId }, process.env.JWT_SECRET!, { expiresIn: "7d" })
}
...
export async function triggerWebhooks(siteId: string, event: string, payload: any): Promise<void> {
  try {
...
// All utility functions are already exported as named exports
